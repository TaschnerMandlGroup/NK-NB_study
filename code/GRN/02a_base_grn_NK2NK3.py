...
OUT             = "/home/sara_wz/bioinf_isilon/Research/HALBRITTER/zHalbritter_TaschnerMandl/wernig-zorc.sara/out/NK_project/GRN/base_GRN_hg38_NK2NK3.parquet"
REF             = "hg38"
...
peaks  = pd.read_csv(f"{IN_DIR}/all_peaks_NK2NK3.csv")["peak"].tolist()
cicero = pd.read_csv(f"{IN_DIR}/cicero_connections_NK2NK3.csv")
